        ...
        <div className={styles.homeLayoutScaleClip}>
          ...
          <section className={styles['hero-intro']}>
            ...
            <div className={styles.aboutTitleRow}>
              ...
              <a
                href="/pdfs/aboadiag-cv-sept-2026.pdf"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <p className={styles['i-am-in-the-fifth-2']}>
              ...
              <span className={styles['text-wrapper-71']}> 
                ...
                >
                  ...
                  <span className={styles['text-wrapper-71']}>{" "}as Senior Robotics Scientist working on human-robot interaction for rehabilitation and caregiving. </span>
